 ...
 */  
public abstract class BasicPatternPNodePQ
{
   ...
   */
  public BasicPatternPNodePQ() { count = 0; } 
   ...
   */
  abstract public void  enq(BasicPatternPNode  item) 
   ...
   */
  abstract public BasicPatternPNode    deq();
   ...
   * @exception TupleUtilsException error in tuple compare routines
   */  
  public boolean pnodeEQ(BasicPatternPNode a, BasicPatternPNode b) throws IOException, UnknowAttrType, TupleUtilsException {
