...
public class BasicPatternUtils
{
   ...
   *         -1        if the tuple is smaller,                              
   */
  public static int compareBasicPatternWithBasicPattern(AttrType fldType,
  ...
  public static int CompareTupleWithValue(AttrType fldType,
    ...
    throws IOException,
	   ...
	   TupleUtilsException
    {
      return compareBasicPatternWithBasicPattern(fldType, t1, t1_fld_no, value, t1_fld_no);
    }
  ...
  public static boolean Equal(Tuple t1, Tuple t2, AttrType types[], int len)
    throws IOException,UnknowAttrType,TupleUtilsException
    {
      ...
      for (i = 1; i <= len; i++)
	if (compareBasicPatternWithBasicPattern(types[i-1], t1, i, t2, i) != 0)
	  return false;
      return true;
    }
