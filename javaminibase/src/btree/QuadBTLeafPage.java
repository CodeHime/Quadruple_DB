...
public class QuadBTLeafPage extends QuadBTSortedPage {
   ...
   *@param dataQid - the qid of the data record. This is
   ...
   *@param qid It will be modified and the first qid in the leaf page
  ...
  public KeyDataEntry getFirst(QID qid) 
    ...
    *@param qid It will be modified and the next qid will be passed out 
