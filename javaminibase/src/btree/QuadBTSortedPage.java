...
// ToDo : HFPage -> THFPage, rid -> qid, HeapFiles -> QuadrupleHeapFiles
// Design Decision -> qid, lid
...
public class QuadBTSortedPage extends THFPage{
   ...
   */
          ...
          throws InsertRecException 
   {
     ...
     try {
       ...
       qid=super.insertQuadruple(record);
   ...
   *@param qid it specifies where a record will be deleted
   *@return true if success; false if qid is invalid(no record in the qid).
